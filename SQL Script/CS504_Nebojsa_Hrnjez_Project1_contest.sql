...
#CREATE DATABASE nhrnjez;
#Uncomment the above code to create a new database, I have it commented becuause my database already exists, if you change 'nhrnjez' you must change
#each instance 'nhrnjez' is called in the code below to whatever you changed to.
...
#This creates the 'Person' relation which holds
...
CREATE TABLE Employee (
    ...
    CONSTRAINT Date_H_Employee CHECK (`Date_Hired` >= DATE_ADD(`Birth_Date`, INTERVAL 18 YEAR)),
...
CREATE TABLE Treats (
    ...
    Pat_id VARCHAR(9) NOT NULL UNIQUE,
...
CREATE TABLE Outpatient (
    ...
    CONSTRAINT UQ_Outpatient UNIQUE (id , Pat_type),
    FOREIGN KEY (id , Pat_type)
        REFERENCES Patient (id , Pat_type)
);
...
CREATE TABLE Scheduled_Visits (
    ...
    CONSTRAINT UQ_Patient UNIQUE (Out_id , Visit_date),
...
VALUES
   (543513291,'2005-03-01','N','1984-04-14'),
    ...
    (123454321,'2018-05-11','S','1995-04-11'),
    (246818642,'2019-06-12','S','1997-05-12'),
    (345612352,'1995-02-13','S','1966-07-16'),
    (777432341,'2001-08-18','S','1974-11-11'),
    (653242310,'2011-07-22','S','1983-9-23');
